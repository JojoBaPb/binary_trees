 ...
 * @tree: Pointer to node of depth to be measured.
 ...
 * @tree: Pointer to root node of tree to find leaf.
...
/**
 * is_perfect_recursive - Checks to see if binary tree is perfect recursively.
